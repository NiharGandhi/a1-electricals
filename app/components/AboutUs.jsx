...
export const AboutUs = () => {
    ...
    return (
        <>
            ...
            <div className="w-full h-full bg-white mt-10 flex flex-col sm:flex-row">
                ...
                <div className="w-full sm:w-1/2 p-8">
                    <div className="bg-gray-100 p-6 rounded-lg shadow-md shadow-orange-500">
                        <div className="relative">
                            <h1 className="mt-2 py-2 text-4xl font-semibold text-gray-900">Our range of products includes the following:</h1>
